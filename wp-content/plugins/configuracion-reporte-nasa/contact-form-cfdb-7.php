<?php
/*
Plugin name: Reporte Astronautas
Plugin URI: https://marulanda.com/
Description: Reporte de leads de nuevos Reporte Astronautas NASA 2021.
Author: David Marulanda
Author URI: https://marulanda.com/
Text Domain: configuracion-reporte-nasa
...
function cfdb7_load_textdomain() {
	load_plugin_textdomain( 'configuracion-reporte-nasa', false, basename( dirname( __FILE__ ) ) . '/languages' );
}
