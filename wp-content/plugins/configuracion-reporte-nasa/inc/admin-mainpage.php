...
class Cfdb7_Wp_Main_Page
{
    ...
    public function admin_list_table_page()
    {
        ...
        add_menu_page( __( 'NASA Astronautas', 'configuracion-reporte-nasa' ), __( 'NASA Astronautas', 'configuracion-reporte-nasa' ), $cfdb7_cap, 'cfdb7-list.php', array($this, 'list_table_page'), 'dashicons-list-view' );
    ...
    public function list_table_page()
    {
        ...
        ?>
            <div class="wrap">
                ...
                <h2><?php _e( 'Contact Forms List', 'configuracion-reporte-nasa' ); ?></h2>
...
class CFDB7_Main_List_Table extends WP_List_Table
{
    ...
    public function get_columns()
    {
        ...
        $columns = array(
            'name' => __( 'Name', 'configuracion-reporte-nasa' ),
            'count'=> __( 'Count', 'configuracion-reporte-nasa' )
        );
