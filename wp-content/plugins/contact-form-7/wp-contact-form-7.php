<?php
/*
Plugin Name: Formulario de Contacto Nasa
Plugin URI: https://marulandapublicidad.com/
Description: Formulario para la NASA.
Author: David Marulanda
Author URI: https://marulandapublicidad.com/
Text Domain: La Nasa
...
define( 'WPCF7_TEXT_DOMAIN', 'formulario-nasa' );

define( 'WPCF7_PLUGIN', __FILE__ );

define( 'WPCF7_PLUGIN_BASENAME', plugin_basename( WPCF7_PLUGIN ) );

define( 'WPCF7_PLUGIN_NAME', trim( dirname( WP_NASA_PLUGIN_BASENAME ), '/' ) );
